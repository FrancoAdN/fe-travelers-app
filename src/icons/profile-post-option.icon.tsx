...
export function ProfilePostIcon({ isSelected }: { isSelected:boolean}) {
  const style = {
    ...BasicIconStyles,
    fill: isSelected ? palette.WHITE : palette.LIGHT_GREY,
  }
  return (
    <svg version="1.1" x="0px" y="0px" viewBox="0 0 198.439 198.439" style={style}>
      <g>
